        ...
        <div className='place-content-center'>
            ...
            <footer className="p-4 bg-slate-100 sm:p-6 dark:bg-gray-900">
                <div className="flex flex-col justify-center items-center md:justify-evenly md:flex-row">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <a href="https://github.com/Shihab-Sabbir" target="_blank" className="hover:underline ">Github</a>
                                </li>
                                <li>
                                    <a href="https://github.com/Shihab-Sabbir" target="_blank" className="hover:underline">Discord</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://github.com/Shihab-Sabbir" target="_blank" className="hover:underline">YourCar™</a>. All Rights Reserved.
                    </span>
