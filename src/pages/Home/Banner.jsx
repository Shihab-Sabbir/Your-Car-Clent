        ...
        <div>
            <div className='relative'>
                ...
                <div className='absolute left-20 top-32 lg:block hidden'>
                    ...
                    <p className='text-2xl text-black dark:text-slate-300'>Quality we guarrantee</p>
                    <button className='btn mt-6 bg-amber-400 border-0 text-slate-100 shadow-md dark:hover:border-white dark:hover:border'>Explore</button>
                </div>
                <div className='flex flex-col w-full justify-center items-center lg:hidden'>
                    ...
                    <p className='text-xl text-black dark:text-slate-300'>Quality we guarrantee</p>
